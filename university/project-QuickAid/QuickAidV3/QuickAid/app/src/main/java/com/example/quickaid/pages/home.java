...
public class home extends AppCompatActivity implements ShakeDetector.ShakeListener{
    ...
    private MaterialCardView logoutBtn,sos_contact_btn,sosBtn, nearby_hospitalbtn, health_trackerbtn, userGuidebtn, supbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        supbtn = findViewById(R.id.emergency_support);
